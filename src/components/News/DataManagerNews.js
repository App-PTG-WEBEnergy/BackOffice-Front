 ...
 import EditContentNews from "views/pages/contents/EditContentNews";
 
 const DataManagerNews = ({ object, callbackitemContent }) => {
   const {
     ADDEDITOR,
     UPDATE_STATUS_URL,
     INIT_ORDER,
   ...
   const columns = [...FixIndexColunm,...STATIC_COLUMNS, ...action_culum];
   const deleteData = () => {
     Modal.confirm({
 ...
 export default DataManagerNews;
