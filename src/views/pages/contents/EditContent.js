...
const EditContent = ({ data, visible, callback, setVisable, type, done }) => {
      ...
      {done || type !== "edit" ? (
        ...
        >
          <Container fluid>
                      ...
                      <Col sm={12} md={6}>
                        <FormGroup>
                          <label
                            ...
                            htmlFor="input-username"
                          >
                            ข้อความสุดท้ายเนื้อหา ภาษาไทย 1
                          </label>
                          <Form.Item
                            name="footer1_th"
                            rules={[
                      ...
                      <Col sm={12} md={6}>
                        <FormGroup>
                          <label
                            ...
                            htmlFor="input-username"
                          >
                            ข้อความสุดท้ายเนื้อหา ภาษาไทย 2
                          </label>
                          <Form.Item
                            name="footer2_th"
                            rules={[
                      ...
                      <Col sm={12}>
                        <FormGroup>
                          ...
                          <JoditEditor
                            ...
                            onBlur={(newContent) => setContentTH(_.get(newContent, 'target.innerHTML', ''))} // preferred to use only this option to update the content for performance reasons
                            onChange={(newContent) => { }}
                          />
                        </FormGroup>
                      </Col>
                      <Col sm={12}>
                        <FormGroup>
                          ...
                          <JoditEditor
                            ...
                            config={config}
                            tabIndex={1} // tabIndex of textarea
                            onBlur={(newContent) => setContent2TH(_.get(newContent, 'target.innerHTML', ''))} // preferred to use only this option to update the content for performance reasons
                            onChange={(newContent) => { }}
                          />
                        </FormGroup>
                      </Col>
                        ...
                        <FormGroup>
                          ...
                          >
                            ...
                            <JoditEditor
                              ...
                              config={config}
                              tabIndex={1} // tabIndex of textarea
                              onBlur={(newContent) => setFooterTH(_.get(newContent, 'target.innerHTML', ''))} // preferred to use only this option to update the content for performance reasons
                              onChange={(newContent) => { }}
                            />
                          </Form.Item>
                        </FormGroup>
                        ...
                        <FormGroup>
                          ...
                          >
                            ...
                            <JoditEditor
                              ...
                              config={config}
                              tabIndex={1} // tabIndex of textarea
                              onBlur={(newContent) => setFooter2TH(_.get(newContent, 'target.innerHTML', ''))} // preferred to use only this option to update the content for performance reasons
                              onChange={(newContent) => { }}
                            />
                          </Form.Item>
                        </FormGroup>
                      ...
                      <Col sm={12} md={6}>
                        <FormGroup>
                          <label
                            ...
                            htmlFor="input-username"
                          >
                            ข้อความสุดท้ายเนื้อหา ภาษาอังกฤษ 1
                          </label>
                          <Form.Item
                            name="footer1_en"
                            rules={[
                      ...
                      <Col sm={12} md={6}>
                        <FormGroup>
                          <label
                            ...
                            htmlFor="input-username"
                          >
                            ข้อความสุดท้ายเนื้อหา ภาษาอังกฤษ 2
                          </label>
                          <Form.Item
                            name="footer1_en"
                            rules={[
                      ...
                      <Col sm={12}>
                        <FormGroup>
                          ...
                          <JoditEditor
                            ...
                            config={config}
                            tabIndex={1} // tabIndex of textarea
                            onBlur={(newContent) => setContentEN(_.get(newContent, 'target.innerHTML', ''))} // preferred to use only this option to update the content for performance reasons
                            onChange={(newContent) => { }}
                          />
                        </FormGroup>
                      </Col>
                      ...
                      <Col sm={12}>
                        <FormGroup>
                          ...
                          <JoditEditor
                            ...
                            config={config}
                            tabIndex={1} // tabIndex of textarea
                            onBlur={(newContent) => setContent2EN(_.get(newContent, 'target.innerHTML', ''))} // preferred to use only this option to update the content for performance reasons
                            onChange={(newContent) => { }}
                          />
                        </FormGroup>
                      </Col>
                        ...
                        <FormGroup>
                          ...
                          >
                            ...
                            <JoditEditor
                              ...
                              config={config}
                              tabIndex={1} // tabIndex of textarea
                              onBlur={(newContent) => setFooterEN(_.get(newContent, 'target.innerHTML', ''))} // preferred to use only this option to update the content for performance reasons
                              onChange={(newContent) => { }}
                            />
                          </Form.Item>
                        </FormGroup>
                        ...
                        <FormGroup>
                          ...
                          >
                            ...
                            <JoditEditor
                              ...
                              config={config}
                              tabIndex={1} // tabIndex of textarea
                              onBlur={(newContent) => setFooter2EN(_.get(newContent, 'target.innerHTML', ''))} // preferred to use only this option to update the content for performance reasons
                              onChange={(newContent) => { }}
                            />
                          </Form.Item>
                        </FormGroup>
            ...
            {data !== null && data.map_url !== null && type === "edit" && (
              <Row>
                <Col sm={12}>
                  <FormGroup>
            ...
            {data !== null && data.tel_no1 !== null && type === "edit" && (
              <>
                <Row>
                  <Col sm={12} md={3}>
                    <FormGroup>
                  ...
                  {data !== null && data.fax_no1 !== null && type === "edit" && (
                    <>
                      <Col sm={12} md={3}>
                        <FormGroup>
                          <label
            ...
            <Row>
              {data !== null && data.image_path1 !== null && type === "edit" && (
                <Col sm={12} md={3}>
              ...
              {data !== null && data.image_path2 !== null && type === "edit" && (
                <Col sm={12} md={3}>
            ...
            {data !== null && data.station_all_num !== 0 && type === "edit" && (
              <>
                <Row>
                  <Col sm={12} md={3}>
                    <FormGroup>
